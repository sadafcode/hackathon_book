---
id: appendix-a-hardware-requirements-lab-setup
...
This appendix details the hardware requirements and various lab setup options for the 'Physical AI & Humanoid Robotics' course. This course is technically demanding, sitting at the intersection of Physics Simulation (Isaac Sim/Gazebo), Visual Perception (SLAM/Computer Vision), and Generative AI (LLMs/VLA).
...
### The "Ether" Lab (Cloud-Native) - High OpEx Option
